      ...
      <ThemeProvider theme={theme === themes.light ? colorsLight : colorsDark}>
        <div>
          ...
          <Wrapper>
            <TitleWrapper>
              <Title>
                <div>{'Top 100 // Corona World News'}</div>
              </Title>
              <div>
                <SocialLink href="https://twitter.com/guptagaurav890" target="blank">
                  <i className="fab fa-twitter" />
                </SocialLink>
                <SocialLink href="https://github.com/gagupt" target="blank">
                  <i className="fab fa-github" />
                </SocialLink>
                <SocialLink href="https://www.linkedin.com/in/gaurav-gupta-337b5669/" target="blank">
                  <i className="fab fa-linkedin" />
                </SocialLink>
                <SocialLink href="https://www.facebook.com/gaurav.gupta123" target="blank">
                  <i className="fab fa-facebook" />
                </SocialLink>
                <SocialLink href="https://gagupt.github.io/Portfolio" target="blank">
